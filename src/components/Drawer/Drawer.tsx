...
const Drawer = ({
  ...
  const positionClasses = {
    ...
    left: "left-0 h-full bottom-0 border-r-2 border-borderColor border-l-0 rounded-r-2xl",
    top: "top-0 w-full",
    bottom: "bottom-0 w-full border-t-2 border-borderColor rounded-t-2xl",
  };
